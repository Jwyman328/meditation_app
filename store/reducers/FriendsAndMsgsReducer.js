...
import friendsAndMsgs_initialState from "../initial_states/friendsAndMsgsData_initialState";

const FriendsAndMsgsReducer = (state = friendsAndMsgs_initialState, action) => {
  switch (action.type) {
    ...
    case "fetchPendingFriendRequestsLoading":
      return {
        ...state,
        fetchPendingFriendRequestsLoading: true,
        fetchPendingFriendRequestsError: false,
      };
    ...
    case "fetchSingleMessagesLoading":
      return {
        ...state,
        fetchSingleMessagesLoading: true,
        fetchSingleMessagesError: false,
      };
