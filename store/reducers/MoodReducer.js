import mood_data_initialState from "../initial_states/moodData_initialState";

const MoodReducer = (state = mood_data_initialState, action) => {
  switch (action.type) {
    case "FetchMoodData":
      ...
      return {
        ...state,
        moodPastWeek: moodDataPastWeek,
        moodPastMonth: moodDataPastMonth,
        moodDates: moodDataDates,
      };
